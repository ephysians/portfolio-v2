      ...
      <div className="md:container px-5 pt-14 min-h-screen flex flex-col justify-between">
        ...
        <div className=" flex items-center justify-center lg:flex-row flex-col-reverse gap-2 p-10">
          ...
          <Swiper
            ...
            spaceBetween={10}
            modules={[Pagination]}
            className="  rounded-md pb-2 w-full min-w-[22rem] drop-shadow-primary self-start relative top-10 sm: bg-400-green"
          >
            {Projects.project_content.map((content, i) => (
              <SwiperSlide
                key={i}
                className="bg-white  p-5 border-b-8 border-[#D5E3F1] h-fit rounded-md"
              >
